...
verificar({id:'pwa-cache',arquivo:'sw.js / pwa-enhancements.js',descricao:'Cache e atualização PWA ativos',condicao:sw.includes('cachePrimeiro')&&sw.includes('redePrimeiro')&&index.includes('pwa-enhancements.js?v=14')&&pwa.includes("register('./sw.js?v=75'"),evidencia:{aprovada:'Estratégias de cache e Service Worker v75 localizados',falha:'Estratégia de cache ou versão atual do Service Worker ausente'},recomendacao:'Manter cachePrimeiro/redePrimeiro e registrar o Service Worker v75.'});
