...
function render(periodo=12){
 const tela=criar(),meses=dados(periodo),todos=meses.flatMap(m=>m.lista),mesAtual=meses[meses.length-1],total=mesAtual?.total||0,com=mesAtual?.comissao||0,media=todos.length/periodo;
