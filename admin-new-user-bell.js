(function(){
  ...
  function estilos(){
    ...
    s.textContent=`
      #scpNewUserBell{position:fixed;top:calc(14px + env(safe-area-inset-top));right:66px;z-index:9998;width:42px;height:42px;border:1px solid #245487;border-radius:50%;background:#0a2039;color:#fff;display:none;align-items:center;justify-content:center;font-size:20px;box-shadow:0 8px 20px rgba(0,0,0,.25);cursor:pointer}
      #scpNewUserBell:hover{transform:translateY(-1px)}
      ...
      body[data-scp-theme="claro"] #scpNewUserBell{background:#fff;color:#17355b;border-color:#d7e2ef;box-shadow:0 8px 20px rgba(18,49,93,.13)}
      ...
      @media(min-width:900px){#scpNewUserBell{right:24px;top:24px}}
    `;
    document.head.appendChild(s);
  }

  function criarSino(){
    if(document.getElementById('scpNewUserBell'))return;
